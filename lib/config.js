...
const setConfig = (options) => {
  ...
  if (options.diskWriteThrottle != null && (options.diskWriteThrottle < 50 || options.diskWriteThrottle > 3000)) {
    const msg = 'Invalid value for diskWriteThrottle. It should be between 50 and 3000 in milliseconds.';
    throw new Error(msg);
  }

  if (options.backupInterval != null && (options.backupInterval < 1 || options.backupInterval > 24)) {
