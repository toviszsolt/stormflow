...
const copyTypeDefinitions = () => {
  const defFiles = ['stormflow.d.ts', 'adapters/fileStorageAdapter.d.ts', 'adapters/fileBackupAdapter.d.ts'];
...
try {
  ...
  const entryPoints = ['src/stormflow.js', 'src/adapters/fileStorageAdapter.js', 'src/adapters/fileBackupAdapter.js'];
